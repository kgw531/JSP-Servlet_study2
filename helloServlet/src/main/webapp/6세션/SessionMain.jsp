...
-->
	...
	<%
		...
		SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss"); // 날짜표기형식
		
		long creationTime = session.getCreationTime(); // 최초 요청(세션 생성) 시각을 알 수 있다.
		String creationTimeStr = sdf.format(new Date(creationTime)); // long타입의 데이터를 날짜형식으로, 날짜형식을 String으로 바꾸는 작업
